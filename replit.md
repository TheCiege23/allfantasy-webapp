...
-   **League Rankings V2 (Team-Level)**: A two-layer team ranking system (Power Rankings and Dynasty Outlook) based on five core scores, with phase-based composite weights and an AI Coach Box. Includes a Motivational Framing System, Luck Meter, and Win Window projection.
...
-   **Devy Player Classification System**: Comprehensive NCAA→NFL player classification with CFBD roster ingestion, stats enrichment, Sleeper API graduation detection, and deterministic availability % scoring.
